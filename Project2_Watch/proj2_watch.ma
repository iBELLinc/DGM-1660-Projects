...
//Name: proj2_watch.ma
//Last modified: Tue, Oct 27, 2020 05:48:28 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 14.425118375440398 9.0633229414763914 16.049182485368167 ;
	setAttr ".r" -type "double3" 1061.6616462405459 -4270.9999999999382 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "D74D60DA-4E9B-7FC7-DF5C-B7BB0A0AEA22";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 19.538164071961063;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -3.5811023724185986e-07 4.4778795102567202 -4.766072343453942e-07 ;
...
createNode transform -n "ConnectWatchFace_Buckleside" -p "Wristband_Parts";
	...
	setAttr ".s" -type "double3" 0.37987827932833085 1.6841267613958377 0.35632651368195328 ;
...
createNode transform -n "ConnectWatchFace_HolepunchedSide" -p "Wristband_Parts";
	...
	setAttr ".s" -type "double3" 0.34585021160178481 1.6832047929602403 0.3244081245553832 ;
...
createNode transform -n "BuckleConnector" -p "Buckle_Parts";
	...
	setAttr ".t" -type "double3" 0 3.2153389245467445 -145.61509408159708 ;
	setAttr ".r" -type "double3" 0 0 89.999999999999957 ;
	setAttr ".s" -type "double3" 0.13063325463359779 1.9103711112368584 0.65272045677401547 ;
...
createNode mesh -n "Watch_FaceShape" -p "Watch_Face";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.58124980330467224 0.68730640411376953 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	...
	setAttr ".pt[99]" -type "float3" 0 -0.069855109 0 ;
	setAttr ".pt[100]" -type "float3" 0 -0.069855109 0 ;
	setAttr ".pt[101]" -type "float3" 0 -0.069855116 0 ;
	setAttr ".pt[102]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[103]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[104]" -type "float3" 0 -0.11333429 0 ;
	setAttr ".pt[105]" -type "float3" 0 -0.11872423 0 ;
	setAttr ".pt[106]" -type "float3" 0 -0.11872423 0 ;
	setAttr ".pt[107]" -type "float3" 0 -0.11872424 0 ;
	setAttr ".pt[108]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[109]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[110]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[111]" -type "float3" 0 -0.11872424 0 ;
	setAttr ".pt[112]" -type "float3" 0 -0.11872424 0 ;
	setAttr ".pt[113]" -type "float3" 0 -0.11872424 0 ;
	setAttr ".pt[114]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[115]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[116]" -type "float3" 0 -0.12236746 0 ;
	setAttr ".pt[117]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[118]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[119]" -type "float3" 0 -0.12236746 0 ;
	setAttr ".pt[120]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[121]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[122]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[123]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[124]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[125]" -type "float3" 0 -0.12236744 0 ;
	setAttr ".pt[126]" -type "float3" 0 -0.069855101 0 ;
	setAttr ".pt[127]" -type "float3" 0 -0.069855101 0 ;
	setAttr ".pt[128]" -type "float3" 0 -0.069855101 0 ;
	setAttr ".pt[129]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[130]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[131]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[132]" -type "float3" 0 -0.11872423 0 ;
	setAttr ".pt[133]" -type "float3" 0 -0.11872423 0 ;
	setAttr ".pt[134]" -type "float3" 0 -0.11872423 0 ;
	setAttr ".pt[135]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[136]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[137]" -type "float3" 0 -0.11333428 0 ;
	setAttr ".pt[138]" -type "float3" 0 -0.11872423 0 ;
	setAttr ".pt[139]" -type "float3" 0 -0.11872423 0 ;
	setAttr ".pt[140]" -type "float3" 0 -0.11872423 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode mesh -n "TimeAdjustKnobShape" -p "TimeAdjustKnob";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 51 ".pt";
	setAttr ".pt[0]" -type "float3" -0.15947722 0 0.031721953 ;
	setAttr ".pt[1]" -type "float3" -0.15022427 0 0.062224906 ;
	setAttr ".pt[2]" -type "float3" 0 0 2.9802322e-08 ;
	setAttr ".pt[4]" -type "float3" -0.09033668 0 0.13519824 ;
	setAttr ".pt[5]" -type "float3" -0.062225029 0 0.16248967 ;
	setAttr ".pt[6]" -type "float3" -3.7252903e-09 0 0.014647067 ;
	setAttr ".pt[8]" -type "float3" 0.031721864 0 0.15947726 ;
	setAttr ".pt[9]" -type "float3" 0.062224802 0 0.15022428 ;
	setAttr ".pt[10]" -type "float3" 0 0 -2.9802322e-08 ;
	setAttr ".pt[12]" -type "float3" 0.13519818 0 0.090336688 ;
	setAttr ".pt[13]" -type "float3" 0.15022418 0 0.062225033 ;
	setAttr ".pt[14]" -type "float3" 1.4901161e-08 0 0 ;
	setAttr ".pt[15]" -type "float3" 4.4703484e-08 0 0 ;
	setAttr ".pt[16]" -type "float3" 0.15947722 0 -0.031721894 ;
	setAttr ".pt[17]" -type "float3" 0.15022424 0 -0.062224835 ;
	setAttr ".pt[19]" -type "float3" -7.4505806e-09 0 0 ;
	setAttr ".pt[20]" -type "float3" 0.090336598 0 -0.13519824 ;
	setAttr ".pt[21]" -type "float3" 0.062224925 0 -0.15022424 ;
	setAttr ".pt[24]" -type "float3" -0.031722032 0 -0.15947726 ;
	setAttr ".pt[25]" -type "float3" -0.062224984 0 -0.1502243 ;
	setAttr ".pt[27]" -type "float3" -1.4901161e-08 0 7.4505806e-09 ;
	setAttr ".pt[28]" -type "float3" -0.1351984 0 -0.090336598 ;
	setAttr ".pt[29]" -type "float3" -0.1502244 0 -0.062224913 ;
	setAttr ".pt[31]" -type "float3" 0 0 2.9802322e-08 ;
	setAttr ".pt[32]" -type "float3" -0.15947722 0 0.031721979 ;
	setAttr ".pt[33]" -type "float3" -0.15022427 0 0.06222488 ;
	setAttr ".pt[35]" -type "float3" -3.7252903e-09 0 0.014647067 ;
	setAttr ".pt[36]" -type "float3" -0.09033668 0 0.14746366 ;
	setAttr ".pt[37]" -type "float3" -0.062225029 0 0.15022424 ;
	setAttr ".pt[39]" -type "float3" 0 0 -2.9802322e-08 ;
	setAttr ".pt[40]" -type "float3" 0.031721864 0 0.15947723 ;
	setAttr ".pt[41]" -type "float3" 0.062224802 0 0.15022431 ;
	setAttr ".pt[43]" -type "float3" -1.4901161e-08 0 0 ;
	setAttr ".pt[44]" -type "float3" 0.13519816 0 0.090336688 ;
	setAttr ".pt[45]" -type "float3" 0.15022422 0 0.062225033 ;
	setAttr ".pt[46]" -type "float3" 4.4703484e-08 0 0 ;
	setAttr ".pt[48]" -type "float3" 0.15947722 0 -0.031721894 ;
	setAttr ".pt[49]" -type "float3" 0.15022424 0 -0.062224835 ;
	setAttr ".pt[50]" -type "float3" -7.4505806e-09 0 0 ;
	setAttr ".pt[52]" -type "float3" 0.090336606 0 -0.13519824 ;
	setAttr ".pt[53]" -type "float3" 0.062224925 0 -0.15022424 ;
	setAttr ".pt[56]" -type "float3" -0.031722032 0 -0.15947726 ;
	setAttr ".pt[57]" -type "float3" -0.062224995 0 -0.1502243 ;
	setAttr ".pt[58]" -type "float3" -1.4901161e-08 0 7.4505806e-09 ;
	setAttr ".pt[60]" -type "float3" -0.13519838 0 -0.090336606 ;
	setAttr ".pt[61]" -type "float3" -0.1502244 0 -0.062224913 ;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "7DE38BCF-4FF6-B74A-304A-C2860CE26CDE";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
...
connectAttr "polySoftEdge13.out" "Watch_FaceShape.i";
...
connectAttr "ConnectWatchFace_BucklesideShape.iog" "lambert2SG.dsm" -na;
connectAttr "ConnectWatchFace_HolepunchedSideShape.iog" "lambert2SG.dsm" -na;
connectAttr "Loop_FurthestBuckleShape.iog" "lambert2SG.dsm" -na;
connectAttr "Loop_ClosestBuckleShape.iog" "lambert2SG.dsm" -na;
